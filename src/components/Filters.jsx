...
const Filters = ({ calls, filters, onFilterChange }) => {
  ...
  return (
    <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl overflow-hidden mb-6 shadow-sm">
      {/* Header */}
      <button
      ...
      {/* Filter Content */}
      {isExpanded && (
        <div className="px-6 pb-6 border-t border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800">
          {/* Search */}
          ...
          <div className="flex flex-col gap-4">
            ...
            <div>
              ...
              <select value={filters.leadOwner} onChange={(e) => handleChange('leadOwner', e.target.value)} className={selectClass}>
            ...
            <div>
              ...
              <select value={filters.state} onChange={(e) => handleChange('state', e.target.value)} className={selectClass}>
            ...
            <div>
              ...
              <select value={filters.course} onChange={(e) => handleChange('course', e.target.value)} className={selectClass}>
            ...
            <div>
              ...
              <select value={filters.callType} onChange={(e) => handleChange('callType', e.target.value)} className={selectClass}>
            ...
            <div>
              ...
              <select value={filters.leadStage} onChange={(e) => handleChange('leadStage', e.target.value)} className={selectClass}>
            ...
            <div>
              ...
              <select value={filters.disposition} onChange={(e) => handleChange('disposition', e.target.value)} className={selectClass}>
                <option value="">All Dispositions</option>
                {filterOptions.dispositions.map((disp) => (
                  <option key={disp} value={disp}>{formatLabel(disp)}</option>
                ))}
              </select>
            </div>
            ...
            <div>
              ...
              <div className="flex items-center space-x-2">
                <input type="number" placeholder="Min" min="0" max="100" value={filters.minScore} onChange={(e) => handleChange('minScore', e.target.value)} className={inputClass} />
                <span className="text-slate-400 dark:text-slate-500">-</span>
                <input type="number" placeholder="Max" min="0" max="100" value={filters.maxScore} onChange={(e) => handleChange('maxScore', e.target.value)} className={inputClass} />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex items-center space-x-2">
                <input type="number" placeholder="Min" min="0" value={filters.minDuration} onChange={(e) => handleChange('minDuration', e.target.value)} className={inputClass} />
                <span className="text-slate-400 dark:text-slate-500">-</span>
                <input type="number" placeholder="Max" min="0" value={filters.maxDuration} onChange={(e) => handleChange('maxDuration', e.target.value)} className={inputClass} />
              </div>
            </div>
          ...
          {activeFiltersCount > 0 && (
            <div className="mt-6 flex justify-end">
              <button
                ...
                className="inline-flex items-center space-x-2 px-4 py-2 bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 border border-slate-200 dark:border-slate-600 text-slate-700 dark:text-slate-300 rounded-xl transition-all duration-200"
              >
