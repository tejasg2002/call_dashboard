...
const STAGES = {
  ...
  opened:    { label: 'Opened',    dot: 'bg-brand-500',  badge: 'bg-brand-50 text-brand-700 dark:bg-brand-900/40 dark:text-brand-300'   },
...
const STAGE_PILL = {
  ...
  opened:    { dot: 'bg-brand-500',  text: 'text-brand-600 dark:text-brand-300',   bg: 'bg-brand-50 dark:bg-brand-900/30',   border: 'border-brand-200 dark:border-brand-700/50',   shadow: '#8b5cf6' },
